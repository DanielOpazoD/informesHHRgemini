...
import { appendInstitutionName } from './branding';

export const TEMPLATES: Record<string, Template> = Object.freeze({
  '1': { id: '1', name: appendInstitutionName('Informe médico de traslado'), title: appendInstitutionName('Informe médico de traslado') },
  '2': { id: '2', name: appendInstitutionName('Evolución médica (FECHA)'), title: appendInstitutionName('Evolución médica (____)') },
  ...
  '6': { id: '6', name: appendInstitutionName('Informe médico'), title: appendInstitutionName('Informe médico') },
});
